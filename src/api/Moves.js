const Moves = [
  ...
  },
  {
    ...
    pp: 10,
    effects: [
      "Bonemerang deals damage and will strike twice (with 50 base power each time).Each strike of Bonemerang is treated like a separate attack:",
    ],
    changes: [
  ...
  },
  {
    ...
    changes: ["In Generations 1-2, the recoil is 1⁄4 of the damage inflicted."],
  },
  {
    name: "dragon rage",
    type: "dragon",
  ...
  },
  {
    ...
    accuracy: 1.0,
    pp: 5,
    effects: ["Explosion deals high damage, but causes the user to faint."],
    changes: [
  ...
  },
  {
    ...
    changes: ["In Generation 1, the crash damage is always 1 HP."],
  },
  {
    name: "horn attack",
    type: "normal",
  ...
  },
  {
    ...
    accuracy: null,
    pp: 20,
    effects: ["User performs the opponent's last move."],
  },
  {
    name: "mist",
    type: "ice",
    ...
    accuracy: null,
    pp: 30,
    effects: ["User's stats cannot be changed for a period of time."],
  },
  {
    name: "night shade",
    type: "ghost",
  ...
  },
  {
    ...
    accuracy: null,
    pp: 20,
    effects: ["Recover restores up to 50% of the user's maximum HP."],
  },
  {
    name: "reflect",
    type: "psychic",
  ...
  },
  {
    ...
    accuracy: null,
    pp: 10,
    effects: ["User sleeps for 2 turns, but user is fully healed."],
  },
  {
    name: "roar",
    type: "normal",
  ...
  },
  {
    ...
    accuracy: 1.0,
    pp: 5,
    effects: ["Self-Destruct deals high damage, but causes the user to faint."],
  },
  {
    name: "sharpen",
    type: "normal",
  ...
  },
  {
    ...
    changes: ["In Generation 1, Skull Bash does not raise the user's Defense."],
  },
  {
    name: "sky attack",
    type: "flying",
  ...
  },
  {
    ...
    accuracy: null,
    pp: 10,
    effects: ["Soft-Boiled recovers up to 50% of the user's maximum HP."],
  },
  {
    name: "solar beam",
    type: "grass",
  ...
  },
  {
    ...
    accuracy: 1.0,
    pp: null,
    effects: ["Only usable when all PP are gone. Hurts the user."],
  },
  {
    name: "stun spore",
    type: "grass",
  ...
  },
  {
    ...
    accuracy: 0.9,
    pp: 10,
    effects: ["Always takes off half of the opponent's HP."],
  },
  {
    name: "supersonic",
    type: "normal",
  ...
  },
  {
    ...
    accuracy: null,
    pp: 10,
    effects: ["User takes on the form and attacks of the opponent."],
  },
  {
    name: "tri attack",
    type: "normal",
  ...
  },
  {
    ...
    changes: [
      "In Generations 1-2, Twineedle can poison Poison and Steel types.In Generations 2-4, if a Focus Sash or Focus Band activates before the final hit, subsequent hits do not cause the holder to faint.",
